...
::like: D:\workspace\AriaDeploy\client, and if workspace is shared then
set default_pePathToClient=Y:\AriaDeploy\client
...
set default_pePathToDrivers=Y:\drivers
...
set default_unattendfileSource=D:\workspace\AriaDeploy\server\resources\unattendXml
